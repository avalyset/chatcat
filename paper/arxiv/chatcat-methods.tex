...
\title{
% PLACEHOLDER --- Eirik to confirm final title.
% Candidates:
% (a) A Criterion-Validity Gate for Threshold-Based Reproducibility Assessment in RL
...
\thanks{Working title; final title to be confirmed at submission.}%
}
